...
public class Nokia extends Phone{
    ...
    public void selfDefense(){
        System.out.println(getBrand() + " " + getModel() + " is in self defense mode");
    }
...
3. Create a class named Nokia:
				...
				Methods:
					setInfo(): sets the brand to "Nokia" and rest of the fields will
					be set based on the given arguments
					call(long phoneNumber)
					text(long phoneNumber)
					selfDefense()
					toString(): prints nokia object info when the object is passed
